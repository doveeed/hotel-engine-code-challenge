...
const ResultsHeader = ({total}) => {
    ...
    return (<div className="results-header">
        ...
        <ResultsSelector onChange={handleSort} value={sort} options={SORT_OPTIONS} labelText="Sort" id="sort-selector" kind="select" />
        <ResultsSelector onChange={handleLanguage} className="show-on-mobile" value={language} options={LANGUAGE_OPTIONS} labelText="Language" id="language-selector" kind="select" />
